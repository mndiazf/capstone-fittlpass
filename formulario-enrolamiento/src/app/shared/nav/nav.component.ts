...
import { CommonModule, NgIf, NgFor, NgSwitch, NgSwitchCase, ViewportScroller } from '@angular/common';
...
@Component({
  standalone: true,
  selector: 'app-nav',
  imports: [CommonModule, NgIf, NgFor, NgSwitch, NgSwitchCase, RouterModule,
